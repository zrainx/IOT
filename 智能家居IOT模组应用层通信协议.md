...
1. 帧格式包括：前导码， 业务载荷长度， 业务载荷，CRC校验
2. 业务载荷包括：目的设备寻址模式 / 目的设备地址长度，源设备ID， 目的设备ID/描述， 数据
3. 数据包括：功能字，功能类型 ，参数长度，参数
4. 参数包括：字符串 或者 设备类型码 ，设备类型参数 
...
参数根据不同的功能类型而不同，功能类型分为业务和维测两类，参数也分为业务和维测两类
